            ...
            <v-flex xs12 sm12 md4>
                <v-card>
                    ...
                    <v-card-actions v-if="['menu'].includes($route.name)">
                        <v-btn block color="blue" class="white--text" @click="showRecipes('keto')">Select This Plan</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
            <v-flex xs12 sm12 md4>
                <v-card>
                    ...
                    <v-card-actions v-if="['menu'].includes($route.name)">
                        <v-btn block color="blue" class="white--text" @click="showRecipes('paleo')">Select This Plan</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
            <v-flex xs12 sm12 md4>
                <v-card>
                    ...
                    <v-card-actions v-if="['menu'].includes($route.name)">
                        <v-btn block color="blue" class="white--text" @click="showRecipes('vegan')">Select This Plan</v-btn>
                    </v-card-actions>
                </v-card>
            </v-flex>
        </v-layout>
